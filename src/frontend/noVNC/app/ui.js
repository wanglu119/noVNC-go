...
const UI = {
    ...
    initSettings() {
        ...
        // wl add 
        UI.initSetting('vncServer', '')
        UI.initSetting('subdomain', '')
        UI.initSetting('auth', '')
 ...
 * ------v------*/
    ...
    connect(event, password) {
        ...
        // wl add
        const vncServer = UI.getSetting('vncServer')
        const subdomain = UI.getSetting('subdomain')
        const auth = UI.getSetting('auth')
        ...
        // wl add
        if(vncServer.length > 0) {
            url += '?vncServer=' + vncServer
